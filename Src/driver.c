...
// This interrupt is used only when STEP_step_pulse.delay is enabled. Here, the step pulse is
// initiated after the STEP_step_pulse.delay time period has elapsed. The ISR TIMER2_OVF interrupt
